...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { name: 'og:title', content: 'taro-bluetooth-print · Taro 跨端蓝牙打印方案' }],
    ['meta', { name: 'og:description', content: '七大平台 · 八种协议 · 零运行时依赖 · 1,102 测试全绿。一套代码自动 dispatch 到所有 Taro 平台与主流打印机协议。' }],
    ['meta', { name: 'og:url', content: 'https://agions.github.io/taro-bluetooth-print/' }],
    ['meta', { name: 'og:image', content: 'https://agions.github.io/taro-bluetooth-print/og-cover.svg' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:title', content: 'taro-bluetooth-print' }],
    ['meta', { name: 'twitter:description', content: '七大平台 · 八种协议 · 零运行时依赖。一套代码自动 dispatch 到所有 Taro 平台与主流打印机协议。' }],
